...
const DeleteDialog = ({ deleteFn }) => {
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="h-10 w-10 bg-white flex items-center justify-center border hover:border-red-400 active:scale-95 transition-all duration-300 ease-in-out rounded-full">
          <LuTrash />
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
